...
const PORT = process.env.PORT || 3000; // Use environment variable for deployment platforms
...
function proxyAPIRequest(apiPath, res) {
    ...
    const options = {
        ...
        headers: {
            ...
            'pragma': 'no-cache',
            'priority': 'u=1, i',
            'referer': 'https://new.land.naver.com/complexes/119652?ms=37.199274,127.0939555,17&a=APT:PRE:ABYG:JGC&e=RETAIL',
